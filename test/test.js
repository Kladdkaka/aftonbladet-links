...
const MAIN_SITEMAP_CONTAIN_STRING = 'aftonbladet.se/sitemap'
const LINKS_SITEMAP_CONTAIN_STRING = 'aftonbladet.se'

const SITEMAP_TEST_URL_FOR_JANUARY_2000 =
  'https://www.aftonbladet.se/sitemaps/files/200101-articles.xml'
...
describe('#Aftonbladet', function() {
  ...
  it(`getLinksFromUrl(url) for url "${SITEMAP_TEST_URL_FOR_JANUARY_2000}" should not be empty`, async function() {
    const links = await AftonbladetLinks.getLinksFromUrl(
      SITEMAP_TEST_URL_FOR_JANUARY_2000
    )
